  ...
  render(){
    return(
      <View style={styles.container}>
        <Image style={styles.icons} source={{uri: "https://img.icons8.com/ios-glyphs/50/000000/user--v1.png"}}></Image>
          ...
          
          {
            this.state.showInfo ?
                <TouchableOpacity onPress={() => this.hideInfo()}>
                  ...
                  <View>
                    <Text style={styles.element}> Fecha de creación: {this.props.userData.metadata.creationTime}</Text>
